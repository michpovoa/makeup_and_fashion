...
if( isset( $_GET['id'] ) ) {
    ...
    $sql = "SELECT * FROM maquiagem WHERE id = '$id'";
...
<section>
    <div class="container">
        ...
        <div class="row">
            ...
            <p class="text-muted">
                <span class="badge badge-danger">Onde encontrar os produtos usados:</span>
                <?= $dados['localizacao']; ?>
            </p>
        </div>
        ...
        <?php include_once 'includes/modal/maquiagem.php'; ?>
